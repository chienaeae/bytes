...
// ChatBubbleMessage
const chatBubbleMessageVariants = cva('p-3 text-sm text-border', {
  variants: {
    variant: {
      received: 'bg-muted rounded-r-lg rounded-tl-lg',
      sent: 'bg-secondary/70 rounded-l-lg rounded-tr-lg',
    },
    layout: {
      default: '',
